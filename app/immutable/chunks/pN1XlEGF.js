const n=`---\r
title: Basics: Wiring and Configuration\r
date: 2026-03-28\r
...
For each port, select the device type and give it a unique name. This name *must* match the string you use in your Java code's \`hardwareMap.get()\` call.\r
\r
\`\`\`java\r
