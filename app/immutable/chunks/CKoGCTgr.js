const n=`---
title: Basics: Wiring and Configuration
date: 2026-03-28
...
For each port, select the device type and give it a unique name. This name *must* match the string you use in your Java code's \`hardwareMap.get()\` call.
