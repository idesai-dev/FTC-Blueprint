	...
	<div class="review-content">
		<div class="text-side">
			...
			<p class="reminder-box">
				<strong>Reminder:</strong> Make sure your code is 
				<code class="email-code">public</code> or accessible.
			</p>
			...
			<div class="form-side" transition:fade>
				...
				{:else}
					<form onsubmit={handleSubmit} class="review-form">
						...
						<input type="text" name="code_link" placeholder="Link to GitHub Repository" required />
						<textarea name="notes" placeholder="Notes (Areas to focus on, specific bugs or files...)" rows="2"></textarea>
