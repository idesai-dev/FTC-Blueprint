...
<style>
    ...
    .sidebar-link.level-1 { font-weight: 600; }
    .sidebar-link.level-2 { font-weight: 500; }
    .sidebar-link.level-3 { font-weight: 400; }
    .sidebar-link.level-4 { font-weight: 400; font-style: italic; }
