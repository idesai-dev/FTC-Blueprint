...
<svelte:head>
	<title>Rookie Guide — Blueprint</title>
...
<div style="display: flex; width:100%; justify-content:flex-end;">
	<div style="width:24vw; background-color:var(--sidebar-bg); border-right:5px solid var(--accent-green); padding:1rem;">
		...
		<p class="sub" style="color:var(--accent-green); font-family:var(--font-heading); font-weight:600; font-size: 1.1rem; margin-top: 1rem; margin-bottom: 0.25rem;">Rookie Guide</p>
		<ol style="padding:0; margin:0; list-style:none; color:var(--text-body);">
			<li style="padding-left:1.25rem; margin-top:0.25rem;"><a href="/complete-rookie-guide/getting-started">Getting Started</a></li>
		</ol>
	</div>
	<div style="width: 100%;">
		<section class="blog-header">
			<div class="container">
				...
				<h1 class="animate-fade-up" style="animation-delay:60ms">The Complete Rookie Guide</h1>
		...
		<section class="filters-section">
			<div class="container animate-fade-up" style="animation-delay:160ms">
				<FilterBar category="Rookie" bind:activeTags={activeTags} bind:searchQuery={searchQuery} />
			</div>
		</section>
				...
				{#if filteredPosts.length > 0}
					<div class="post-grid stagger">
						{#each filteredPosts as post}
							<BlogCard {post} basePath="/complete-rookie-guide" />
						{/each}
					</div>
				{:else}
